...
food = {
    "🥖 Зерновые и хлебобулочные изделия": ['Хлеб', "Батон", "Выпечка", "Мука", "Печенье"],
    "🥩 Мясо, рыба, яйца и бобовые" : ["Курица", "Говядина", "Свинина", "Яйца", "Фарш"],
    "🥛 Молочные продукты" : ["Молоко", "Кефир", "Сметана", "Йогурт", "Сливки"],
    "🍏 Фрукты и ягоды" : ["Бананы", "Яблоки", "Груша", "Клубника", "Черника"],
    "🥦 Овощи и зелень" : ["Картошка", "Морковь", "Лук", "Чеснок", "Зелень"]
}
...
for category in categories:
    for _ in range(20):
        product = {
            "id": f"prd-{1000+i}",
            "name": f'{fake.word().capitalize()} {random.choice(food[category])}',
            "group": category,
